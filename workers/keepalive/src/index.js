...
const enabledModels = [
  ...
  { modelName: 'votepurchase/novaAnimeXL_ilV70', negativePrompt: 'modern, recent, old, oldest, cartoon, graphic, text, painting, crayon, graphite, abstract, glitch, deformed, mutated, ugly, disfigured, long body, lowres, bad anatomy, bad hands, missing fingers, extra digit, fewer digits, cropped, very displeasing, (worst quality, bad quality:1.2), bad anatomy, sketch, jpeg artifacts, signature, watermark, username, signature, simple background, conjoined,bad ai-generated' },
  { modelName: 'votepurchase/waiIllustriousSDXL_v150', negativePrompt: 'bad quality,worst quality,worst detail,sketch,censor' },
  { modelName: 'votepurchase/shiitakeMix_v20', negativePrompt: '(bad quality,worst quality,low quality,bad anatomy,bad hand:1.3), nsfw, lowres, bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username, blurry, artist name,' },
  ...
  { modelName: 'votepurchase/matureRitual_v20beta', negativePrompt: 'bad quality,worst quality,worst detail,sketch,censor' },
